...
const Home = () => {
  ...
  const recentActivities = [
    {
      action: "Crop prediction completed",
      time: "2 min ago",
      status: "success",
    },
    {
      action: "Water level alert triggered",
      time: "15 min ago",
      status: "warning",
    },
    {
      action: "Disease detection scan finished",
      time: "1 hour ago",
      status: "info",
    },
    {
    ...
    >
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-4 sm:p-6 text-white">
        ...
        <p className="text-green-100 text-lg">
          Monitor and manage your agricultural IoT system with intelligent
          insights
        </p>
      </div>
